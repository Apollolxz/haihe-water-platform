...
let particlesImportPromise = null;
...
function ensureParticles() {
  particlesImportPromise ||= import('particles.js');
  return particlesImportPromise;
}
...
function initParticleBackground() {
  ...
  ensureParticles().then(() => {
    if (cancelled || typeof window.particlesJS !== 'function' || !document.getElementById('particles-js')) {
      return;
    }
