...
const legacyPages = {
  ...
  "knowledge-graph.html": { title: "海河六域｜知识图谱", scripts: ["https://cdn.jsdelivr.net/npm/vis-network@9.1.9/dist/vis-network.min.js","../config/site.config.js","../config/runtime-config.js","../assets/js/nav-search.js","../assets/js/knowledge-graph-page.js?v=20260427-restore"], Component: KnowledgeGraphPage },
