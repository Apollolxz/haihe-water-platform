...
const legacyPages = {
  ...
  "dashboard.html": { title: "海河六域・水质时空演变智能治理系统", scripts: ["https://cdn.jsdelivr.net/npm/echarts@5.4.3/dist/echarts.min.js","../config/site.config.js","../config/runtime-config.js","../assets/js/dashboard-screen.js?v=20260420d"], inlineScripts: [], Component: DashboardPage },
  ...
  "knowledge-graph.html": { title: "海河六域｜知识图谱", scripts: ["https://cdn.jsdelivr.net/npm/vis-network@9.1.9/dist/vis-network.min.js","https://cdn.jsdelivr.net/npm/echarts@5.4.3/dist/echarts.min.js","../config/site.config.js","../config/runtime-config.js","../assets/js/knowledge-graph-page.js?v=20260427-legacy855"], inlineScripts: [], Component: KnowledgeGraphPage },
  ...
  "sandbox.html": { title: "流域时空推演沙盘｜模型预测与多维验证", scripts: ["https://cdn.jsdelivr.net/npm/echarts@5.4.3/dist/echarts.min.js","../config/site.config.js","../config/runtime-config.js","../assets/js/sandbox-validation.js?v=20260427b"], inlineScripts: [], Component: SandboxPage },
