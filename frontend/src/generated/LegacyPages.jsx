...
const legacyPages = {
  "boxplot-analysis.html": { title: "海河六域 - 指标分布与异常预警专项屏", scripts: ["../config/site.config.js","../config/runtime-config.js"], Component: BoxplotAnalysisPage },
  "chat.html": { title: "海河六域 - 智能问答", scripts: ["https://cdn.jsdelivr.net/particles.js/2.0.0/particles.min.js","../config/site.config.js","../config/runtime-config.js"], Component: ChatPage },
  "correlation-analysis.html": { title: "海河六域 - 指标相关性分析专项屏", scripts: ["../config/site.config.js","../config/runtime-config.js"], Component: CorrelationAnalysisPage },
  "dashboard.html": { title: "海河六域・水质时空演变智能治理系统", scripts: ["../config/site.config.js","../config/runtime-config.js","../assets/js/dashboard-screen.js?v=20260420d"], Component: DashboardPage },
  ...
  "index.html": { title: "海河六域 - 流域水质时空演变与知识图谱智能治理系统", scripts: ["../config/site.config.js","../config/runtime-config.js"], Component: IndexPage },
  "knowledge-graph.html": { title: "海河六域｜知识图谱", scripts: ["https://cdn.jsdelivr.net/npm/vis-network@9.1.9/dist/vis-network.min.js","../config/site.config.js","../config/runtime-config.js","../assets/js/knowledge-graph-page.js?v=20260427-legacy855"], Component: KnowledgeGraphPage },
  ...
  "sandbox.html": { title: "流域时空推演沙盘｜模型预测与多维验证", scripts: ["../config/site.config.js","../config/runtime-config.js","../assets/js/sandbox-validation.js?v=20260427b"], Component: SandboxPage },
