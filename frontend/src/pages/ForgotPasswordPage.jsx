...
export default function ForgotPasswordPage({ page, pageName }) {
  ...
  return (
    <>
      ...
      <div className="min-h-screen w-full max-w-md mx-auto flex items-center justify-center px-4 py-10 animate-slide-up relative z-10">
          ...
          <div className="card-glass rounded-2xl p-8 border border-white/10 card-shadow">
            <form id="forgotPasswordForm" className="space-y-6">
              ...
              <div className="text-center text-sm">
                <a href="login.html" data-page-link="login.html" className="text-primary font-medium hover:text-white transition-colors">
                  返回登录页
                </a>
              </div>
            </form>
